...
export const { toggleIsDark, addOutfit, addItem, addTag, deleteTag, changeSelected, changeClosetSort, changeHistorySort, changeClosetDisplay, changeHistoryDisplay } = appSlice.actions;
